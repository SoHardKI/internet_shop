    ...
    <script>
        $(document).ready(function () {
            ...
            $('.shopping_cart').on('click', function (){
                redirectCartFunction();
            });
        });

        var redirectCartFunction = function () {
            var url = new URL("{{route('cart.index')}}");
            for(let i=0; i < localStorage.length; i++) {
                url.searchParams.append(localStorage.key(i), parseInt(localStorage.getItem(localStorage.key(i))));
            }

            window.location = url.href;
        };

         var setCountFunction = function (){
            let count = 0;
            for(let i=0; i < localStorage.length; i++) {
...
<div class="super_container">
    ...
    <header class="header">
                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="/">ITPolice.</a></div>
                            <nav class="main_nav">
                                <ul>
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{route('main.category', ['category' => $category->id])}}">{{$category->name}}</a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                </ul>
        ...
        <div class="header_social">
            <ul>
                <li><a href="https://t.me/ip_police_orders"><i class="fa fa-telegram" aria-hidden="true"></i></a></li>
            </ul>
        </div>
    </header>
            ...
            <div class="row">
                <div class="col">
                    <div
                        ...
                        <div class="footer_logo"><a href="#">ITPolice.</a></div>
